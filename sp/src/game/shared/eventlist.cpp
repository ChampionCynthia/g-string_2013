...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_PLAYER_1, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_PLAYER_2, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_PLAYER_3, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_PLAYER_4, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_PLAYER_5, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_OBJECT_1, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_OBJECT_2, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_OBJECT_3, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_OBJECT_4, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_GSTRING_INTERACTION_OBJECT_5, AE_TYPE_SERVER );
}